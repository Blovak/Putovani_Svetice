...
The current production release is Apps Script version 31. It includes the
...
refreshed every five minutes. The total-distance endpoint is available to every
authenticated participant, not only administrators.
